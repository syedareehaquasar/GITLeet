        ...
        xhr.addEventListener('readystatechange', function() {
            if (xhr.readyState === 4) {
                if (xhr.status === 200) {
                        ...
                        if (data2 && data2.mode_type === 'commit') {
                            ...
                            chrome.storage.local.get(
                                ...
                                (data3) => {
                                    ...
                                    const gitleetHook = data3.gitleet_hook;
                                    if (gitleetHook) {
                                        $('#repo_url').html(
                                            `<a target="blank" style="color: cadetblue !important; font-size:0.8em;" href="https://github.com/${gitleetHook}">${gitleetHook}</a>`,
                                        );
                                    }
                                },
                            );
                    ...
                    chrome.storage.local.set({ gitleet_token: null }, () => {
                        console.log(
